...
wwv_flow_fnd_user_api.create_fnd_user (
  ...
  p_last_name                    => 'Smith',
  p_description                  => '',
  p_email_address                => 'email id',
  p_web_password                 => '944351C0EC95F090Bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1',
...
wwv_flow_fnd_user_api.create_fnd_user (
  ...
  p_description                  => '',
  p_email_address                => 'email id',
  p_web_password                 => 'D166B280355531C8C1FEDBEXXXXXXXXXXXXXXXXX26B8BA9915',
  p_web_password_format          => '5;5;10000',
  p_group_ids                    => '',
  p_developer_privs              => '',
  p_default_schema               => 'MLOPSU1',
...
wwv_flow_fnd_user_api.create_fnd_user (
  ...
  p_description                  => '',
  p_email_address                => 'email id',
  p_web_password                 => '6010548B3278XXXXXXXXXXXXXXXXXXXXXXXXXXXX3857F',
  p_web_password_format          => '5;5;10000',
  p_group_ids                    => '',
...
wwv_flow_fnd_user_api.create_fnd_user (
  ...
  p_description                  => '',
  p_email_address                => 'email id',
  p_web_password                 => 'AE45DA245B2XXXXXXXXXXXXXXXXXXXXAD08A',
  p_web_password_format          => '5;5;10000',
  p_group_ids                    => '',
  p_developer_privs              => '',
  p_default_schema               => 'MLOPSU1',
...
begin
  wwv_flow_api.create_password_history (
    ...
    p_user_id => 10107235045587860,
    p_password => '315CAEA480CDEDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXFF8985C890B8A1');
end;
/
begin
  wwv_flow_api.create_password_history (
    ...
    p_user_id => 12907686636921187,
    p_password => 'AE45DA245BXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXF64EF3AD08A');
end;
/
begin
  wwv_flow_api.create_password_history (
    ...
    p_user_id => 13038845399546945,
    p_password => '5BBE6AECB7EXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX5A7CBA820C3D193');
end;
/
begin
  wwv_flow_api.create_password_history (
    ...
    p_user_id => 13038845399546945,
    p_password => '944351C0EC95FXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXE19B3EB73824F1');
end;
/
begin
  wwv_flow_api.create_password_history (
    ...
    p_user_id => 10107235045587860,
    p_password => 'B7F803B1A5BC6XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXBD14E1B2783B0BBD6D2168C1');
end;
/
begin
  wwv_flow_api.create_password_history (
    ...
    p_user_id => 13040262360660685,
    p_password => 'D166B2803555XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX4C1913EAF5326B8BA9915');
end;
/
begin
  wwv_flow_api.create_password_history (
    ...
    p_user_id => 13040262360660685,
    p_password => '35C1579B34BDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX855389811A22F495E');
end;
/
begin
  wwv_flow_api.create_password_history (
    ...
    p_user_id => 10107235045587860,
    p_password => '6010548B3278XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX8468DF5B15BD3857F');
end;
/
----------------
--preferences
